...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "5902872993:AAFKSUq4y1HHOHaceAiKG9hGO8j0kAuCY_k")
    ...
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "Ashq4ana_bot")
    SUPPORT = os.environ.get("SUPPORT", "Dlle_rashGroup") # Your Support
    CHANNEL = os.environ.get("CHANNEL", "Ashq4ana") # Your Channel
